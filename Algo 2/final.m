...
% Last Modified by GUIDE v2.5 06-May-2014 00:01:05
...
global im
global fname
[fname pathname]=uigetfile(('*.jpg'),'file selector');
im=strcat(pathname,fname);
display(im);
axes(handles.axes1)
imshow(im)
...
start;
global letter
set(handles.edit1,'String',upper(letter));
...
%set(handles.edit2,'String','vinay');
